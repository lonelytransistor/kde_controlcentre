...
Item {
    ...
    readonly property var lzw: Item {
        ...
        readonly property var decompress: function (compressed) {
            "use strict";
            // Build the dictionary.
            var i,
                dictionary = [],
